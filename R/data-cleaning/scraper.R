...
readr::write_csv(past_sal, "data/team-past-salaries.csv")


# Franchise Values

u = rvest::read_html("https://en.wikipedia.org/wiki/Forbes_list_of_the_most_valuable_MLB_clubs")
franch = rvest::html_table(u)[[3]]

readr::write_csv(franch, "data/franchise-values.csv")
